...
if(isset($_POST['btn_guardar'])){
    ...
    $datos_semana = array($_POST['Mon'],$_POST['Tue'],$_POST['Wed'],$_POST['Thu'],$_POST['Fri'],$_POST['Sat']);
...
<script> 
    //al pulsar el botón de editar se habilitan los imputs
           ...
           */
            ...
            foreach ($semana as $dia){
                ...
                if($dia){
                    ...
                    //Botón d edición
                    echo'<td>';
                    //Solo lo muestra si el día es anterior a la fecha actual
                    ...
                    //// AVISOS calculados dinamicamente segunlos valores del día
